<div class="container">
  ...
  <?php echo form_open_multipart('relatorio/folha', 'class="form-horizontal clearfix" onsubmit="overlay(true)"'); ?>
  <fieldset class="col-sm-6 center col-lg-offset-3">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <select name="<?php echo Model_Filial::ID; ?>" id="filial" class="form-control">
