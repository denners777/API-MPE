...
(function(e){e.fn.tablecloth=function(t){var n={theme:"default",customClass:"",bordered:false,condensed:false,striped:false,sortable:false,clean:false,cleanElements:"*"};var r=e.extend(n,t);this.find("*").each(function(){if(e(this).attr("align")=="right"){e(this).addClass("right")}if(e(this).attr("align")=="center"){e(this).addClass("center")}if(e(this).attr("nowrap")){e(this).css("white-space","nowrap")}});if(r.clean){this.removeAttr("class").removeAttr("style").removeAttr("cellpadding").removeAttr("cellspacing").removeAttr("bgcolor").removeAttr("align").removeAttr("width").removeAttr("nowrap");this.find(r.cleanElements).each(function(){e(this).removeAttr("style").removeAttr("cellpadding").removeAttr("cellspacing").removeAttr("bgcolor").removeAttr("align").removeAttr("width").removeAttr("nowrap")})}if(r.theme=="default"){this.addClass("table")}else if(r.theme=="dark"){this.addClass("table table-dark")}else if(r.theme=="stats"){this.addClass("table table-stats")}else if(r.theme=="paper"){this.addClass("table table-paper")}if(r.customClass!=""){this.addClass(r.customClass)}if(r.condensed){this.addClass("table-condensed")}if(r.bordered){this.addClass("table-bordered")}if(r.striped){this.addClass("table-striped")}if(r.sortable){this.addClass("table-sortable");if(jQuery().tablesorter){this.tablesorter({cssHeader:"headerSortable"})}else{console.log("Tablesorter is not loaded")}}}})(jQuery);
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      container_div = $("<div />", {
        ...
        "class": "form-control chzn-container " + (this.is_rtl ? 'chzn-rtl' : ''),
        style: 'width: 100%'
